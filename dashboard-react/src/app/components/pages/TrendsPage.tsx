...
export function TrendsPage() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <ChartCard title="Tren Sentimen Positif (Per Tahun)" description="Persentase ulasan positif rata-rata per tahun">
        <TrendLine data={yearTrend} />
      </ChartCard>

      <ChartCard title="Volume Ulasan (Per Tahun)" description="Jumlah ulasan positif dan negatif tahunan">
        <VolumeStackedBar data={yearTrend} />
      </ChartCard>
    </div>
  );
}
